...
| 🔧 | [Enterprise Network Configuration — Cisco Packet Tracer](cisco-packet-tracer-network-config) | Designed and deployed a multi-department network (Admin/Sales/HR) with router-based inter-VLAN routing, DHCP/DNS server setup, and ACL security rules — verified with controlled ping tests proving access enforcement | Network Design · ACL · Routing · DHCP/DNS |
